CLASS zcl_mcdli_cust_vh_re_rhythm DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_MCDLI_CUST_VH_RE_RHYTHM IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    DATA lt_result TYPE TABLE OF zmcdli_u_vh_re_rhythm.
    ...
    TRY.
        ...
        lo_entity_list_resource = lo_client_proxy->create_resource_for_entity_set( 'A_RECONTRRHYTHMTERM' ).
        ...
        lo_read_list_request->set_select_properties( VALUE #( ( CONV #('INTERNALREALESTATENUMBER') )
                                                              ...
                                                              ( CONV #('RESTARTFREQUENCYWEEK') )
                                                              ( CONV #('REFREQUENCYSTART') ) ) ).

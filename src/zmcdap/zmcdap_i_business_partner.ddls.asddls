...
define view entity ZMCDAP_I_BUSINESS_PARTNER as select from I_BusinessPartner
association to I_Businesspartnertaxnumber as _BpTaxNum on $projection.BusinessPartner = _BpTaxNum.BusinessPartner
{
    key BusinessPartner,
    ...
    _BpTaxNum.BPTaxNumber as BPTaxNumber,
    /* Associations */
    _AcademicTitleText,
